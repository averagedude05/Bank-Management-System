...
public class Withdraw extends MainMenu{
  ...
  double ws;
    ...
    Withdraw(){
      ...
      frame3.getContentPane().setBackground(new Color(0,128,255));
      ...
      okBtn2.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          if (e.getSource() == okBtn2) {
            ws=Double.parseDouble(transferField.getText());
    ...
    public void witdraw() {
      ...
      transactionpg.balance -= ws;  // Update the static balance in transactionpg
